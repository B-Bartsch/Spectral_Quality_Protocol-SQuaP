...
double precision, intent(in) :: theta, refr(nw)
double precision, intent(out) :: res(nw)

double precision pi, thetarad
double precision refr2(nw)
double precision ax(nw),bx(nw),b0(nw),b1(nw),b2(nw)
double precision ts(nw),tp(nw),tp1(nw),tp2(nw),tp3(nw),tp4(nw),tp5(nw)
